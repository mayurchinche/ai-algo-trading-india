...
for(const file of ['trading','mobile-alerts','foreground-alerts','backend','production-data','paper-engine','paper-funds','device-paper','paper-workspace','paper-workflow','shared-paper']) {
