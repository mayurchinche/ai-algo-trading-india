...
for(const file of ['trading','mobile-alerts','foreground-alerts','backend']) {
...
for(const args of [['--test','.test-build/trading.test.mjs','.test-build/mobile-alerts.test.mjs','.test-build/foreground-alerts.test.mjs','.test-build/backend.test.mjs'],['tests/mobile-database.mjs']]) {
