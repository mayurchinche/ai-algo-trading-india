...
export const watchlist: Stock[] = [
  ...
  { symbol: 'TMCV', name: 'Tata Motors Ltd (CV)', sector: 'Auto - CV', ltp: 470.40, change: -3.90, changePct: -0.82, dayHigh: 478.00, dayLow: 465.00, open: 474.00, prevClose: 474.30, volume: 8500000, avgVolume: 7000000, marketCap: '1.8L Cr', pe: 6.2, weekHigh52: 550.00, weekLow52: 310.00, rsi: 48.0, sma20: 465.00, sma50: 440.00, signal: 'NEUTRAL', aiScore: 62 },
  { symbol: 'TMPV', name: 'Tata Motors Passenger Vehicles Ltd', sector: 'Auto - PV', ltp: 331.55, change: -2.95, changePct: -0.88, dayHigh: 338.00, dayLow: 328.00, open: 334.00, prevClose: 334.50, volume: 6200000, avgVolume: 5500000, marketCap: '1.6L Cr', pe: 14.5, weekHigh52: 400.00, weekLow52: 250.00, rsi: 44.0, sma20: 335.00, sma50: 320.00, signal: 'NEUTRAL', aiScore: 58 },
...
export const allTrades: Trade[] = [
  ...
  { id: 'T002', symbol: 'TMCV', side: 'BUY', quantity: 150, entryPrice: 474.30, currentPrice: 470.40, exitPrice: null, stopLoss: 460.00, takeProfit: 510.00, status: 'OPEN', pnl: -585, pnlPct: -0.82, charges: 96, netPnl: -681, strategy: 'Mean Reversion + RSI', confidence: 0.79, entryTime: '2026-08-15 09:35:42', exitTime: null, holdingDuration: '1h 18m', reason: 'RSI bounce from 35 + CV segment momentum + fleet replacement cycle. Volume 1.6x avg confirms institutional interest.', riskRewardRatio: 2.0 },
...
export const stockAnalysis: StockAnalysis[] = [
  ...
  { symbol: 'TMCV', totalTrades: 11, wins: 8, losses: 3, winRate: 72.7, totalPnl: 11200, avgPnl: 1018, bestTrade: 3800, worstTrade: -1900, avgHoldingTime: '1h 50m', sharpe: 2.10, maxConsecutiveLosses: 2, profitFactor: 2.78 },
