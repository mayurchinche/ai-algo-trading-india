          ...
          <div className="card">
            ...
            <table className="data-table">
              ...
              <tbody>
                ...
                <tr><td className="font-medium">TMCV</td><td className="text-[11px]">HDFC MF, SBI MF, Kotak MF</td><td><span className="badge badge-green">ACCUMULATE</span></td><td className="text-right font-mono">₹600</td><td className="text-[11px]">CV market leadership + fleet cycle</td><td className="text-[11px]">18-24 months</td></tr>
                <tr><td className="font-medium">TMPV</td><td className="text-[11px]">HDFC MF, SBI MF, Kotak MF</td><td><span className="badge badge-green">ACCUMULATE</span></td><td className="text-right font-mono">₹450</td><td className="text-[11px]">EV leadership + PV market share</td><td className="text-[11px]">18-24 months</td></tr>
