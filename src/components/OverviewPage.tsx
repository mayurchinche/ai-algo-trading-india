...
export function OverviewPage() {
  ...
  return <div className="space-y-6"><div className="page-title"><div><p className="eyebrow">Measure before you scale</p><h2>Performance, from the ledger.</h2><p>Recorded executions only. No hypothetical entries at yesterday’s close.</p></div></div>
