...
const signals: Signal[] = [
  ...
  { symbol: 'TATAMOTORS', direction: 'BUY', confidence: 0.79, strategy: 'Mean Reversion + RSI', reason: 'Auto sector momentum. JLR earnings beat estimates. RSI bounced from 42 with volume confirmation. Nifty Auto at all-time high.', timestamp: '09:35:42', indicators: { rsi: 71.2, smaSignal: 'Price > SMA20 > SMA50', volumeRatio: 1.6 } },
