...
export function ServerPaperPage() {
 ...
 return <section className="space-y-4"><div className="page-title"><div><p className="eyebrow">YOUR PAPER ACCOUNT · NO SIGN-IN REQUIRED</p><h2>Your capital. Your progress.</h2><p>A complete record of your trades, balance and decisions.</p></div></div>
